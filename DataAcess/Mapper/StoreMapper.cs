    ...
    public class StoreMapper : EntityMapper, ISqlStaments, IObjectMapper
    {
        ...
        public BaseEntity BuildObject(Dictionary<string, object> row)
        {
            var store = new Store
            {
                ...
                IdCellar = GetIntValue(row, DB_COL_CELLAR)
            };
        ...
        public SqlOperation GetCreateStatement(BaseEntity entity)
        {
            ...
            operation.AddVarcharParam(DB_COL_PHONE, store.Phone);
        ...
        public SqlOperation GetCellarIdStatement(BaseEntity entity)
        {
            var operation = new SqlOperation { ProcedureName = "RET_STORE_CELLAR_PR" };
        ...
        public SqlOperation GetStoreByUserStatement(BaseEntity entity)
        {
            var operation = new SqlOperation { ProcedureName = "RET_STORE_BY_USER_PR" };
            var storeAdministrator = (StoreAdministrator)entity;
            operation.AddVarcharParam(DB_COL_EMAIL, storeAdministrator.Email);
